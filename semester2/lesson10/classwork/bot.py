...
async def start_process(message: types.Message):
    await message.answer('Привіт! Я бот - із машнами. Дляреєстрації - пошир контакт', reply_markup=request_contact)

@dp.message_handler(ontent_types=types.ContentTypes.CONTACT)
